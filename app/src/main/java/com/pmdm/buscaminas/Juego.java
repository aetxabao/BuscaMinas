...
public class Juego {
    ...
    private Fase[] fases = {new Fase(4,4,2,R.drawable.trench),new Fase(4,4,3,R.drawable.trench),new Fase(4,4,4,R.drawable.trench),
                            new Fase(4,6,5,R.drawable.stormtroops),new Fase(4,6,6,R.drawable.stormtroops),new Fase(4,6,7,R.drawable.stormtroops),
                            new Fase(6,8,10,R.drawable.chateau),new Fase(6,8,12,R.drawable.chateau),new Fase(6,8,14,R.drawable.chateau),
                            new Fase(8,8,20,R.drawable.ship),new Fase(8,8,24,R.drawable.ship),new Fase(8,8,28,R.drawable.ship)};
    /** Si se ha encontrado un camino */
    private boolean finFase = false;
    /** Si se han agotado todas las vidas */
     ...
     * @param fuegos número de celdas que son fuego
     */
    public Juego(int filas, int columnas, int fuegos) {
    ...
    /**
     * Fija la situación de fin de partida al acabarse las vidas
